import { XyoBoundWitnessBuilder, XyoWallet } from '@xyo-network/sdk-xyo-client-js'
...
describe('/schema', () => {
  ...
  const bw = new XyoBoundWitnessBuilder({ inlinePayloads: true }).payload({ definition, schema }).witness(XyoWallet.random()).build()
  beforeAll(async () => {
