...
export interface IDataResource<T extends IResourceIdentifierObject> extends IResourceBase {
  data: T
...
export type IResource<T extends IResourceIdentifierObject> = IDataResource<T> | IErrorResource
