...
export type ElevationDivinerConfigSchema = 'network.xyo.location.elevation.config'
export const ElevationDivinerConfigSchema: ElevationDivinerConfigSchema = 'network.xyo.location.elevation.config'
